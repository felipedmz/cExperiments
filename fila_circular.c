...
typedef struct{
     ...
     int tamanhoFila; // testar se fila está cheia / vazia
...
//Função para remover elementos da fila circular
int removeFila(Fila* f){
     int removido;
...
//Função para mostrar a fila circular
void mostraFila(Fila* f){
     int i, cont;
...
//Função para checar se a fila circular está vazia
int filaVazia(Fila* f){
